...
<div class="row">
    <div class="col-12">
        <div class="p-20">
            <a href="<?php echo site_url('school/students/add'); ?>"><button class="btn btn-sm btn-primary waves-effect waves-light">
...
<script type="text/javascript">
    ...
    function DataTable(filter){
        $('#datatable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('school/students/datatables')?>?school="+filter,
                "type": "POST"
            },
            "columnDefs": [
                { 
