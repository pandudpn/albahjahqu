<div class="row">
    <div class="col-xl-12">
        <div class="page-title-box">
            <h4 class="page-title float-left">Data Staff / Guru</h4>
...
<div class="row">
    <div class="col-12">
        <div class="p-20">
            <a href="<?php echo site_url('school/staff/add'); ?>"><button class="btn btn-sm btn-primary waves-effect waves-light">
                <i class="zmdi zmdi-collection-plus"></i> Tambah Staff / Guru </button>
            </a>
        </div>
        ...
        <div class="card-box table-responsive" style="overflow-x: auto; zoom: 0.8;">
            ...
            <table id="datatable" class="table table-striped table-bordered" style="min-width: 1300px">
                <thead>
                <tr>
                    <th width="4%">No</th>
                    <th>Sekolah</th>
...
<script type="text/javascript">
    ...
    function DataTable(filter){
        $('#datatable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('school/staff/datatables')?>?school="+filter,
                "type": "POST"
            },
            "columnDefs": [
                { 
