...
<div class="row">
    <div class="col-12">
        <div class="p-20">
            <a href="<?php echo site_url('dealers/add'); ?>"><button class="btn btn-sm btn-primary waves-effect waves-light">
                <i class="zmdi zmdi-collection-plus"></i> Add Dealer </button>
            </a>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('dealers/datatables')?>",
                "type": "POST"
            },
