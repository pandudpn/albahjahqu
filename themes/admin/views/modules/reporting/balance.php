<div class="row">
    <div class="col-xl-12">
        <div class="page-title-box">
            <h4 class="page-title float-left">Saldo</h4>
        ...
        <div class="card-box table-responsive" style="overflow-x: auto; zoom: 0.8;">
            ...
            <!-- <form method="get" id="form">
                <div class="row" style="margin-bottom: 15px; margin-left: 5px;">
                    ...
                    <div class="col-2"><button class="btn btn-primary">Go</button> <a href="<?php echo site_url('reporting/balance'); ?>" class="btn btn-secondary">Reset</a></div>
                </div>
            </form> -->
...
<script type="text/javascript">
    ...
    function Data(from, to){
        var url = '<?= site_url("reporting/balance/datatables"); ?>';
        $('#datatable').DataTable({ 
            // "scrollX": true,
