...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            ...
            <div class="row">
                <div class="col-6">
                    <form method="post" action="<?php echo site_url('community/achievement_staff/save'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-form-label col-3">Pengurus / Guru</label>
                            <div class="col-9">
                                <select name="staff" id="staff" class="form-control" required="required">
                                    <option value="" selected disabled>-</option>
                                    <?php if(isset($data)){
                                        foreach($staff AS $s){ ?>
                                            <option value="<?= $s->id; ?>" <?php echo ($data->staff_id == $s->id) ? 'selected' : null ?>><?php echo $s->name; ?></option>
                                        <?php } 
                                    } ?>
                                </select>
                            </div>
                        ...
                        <a href="<?php echo site_url('community/achievement_staff'); ?>" class="btn btn-danger waves-effect waves-light">
                            Batal
                        </a>
                    </form>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#unit').change(function(e){
            ...
            $.ajax({
                url: '<?php echo site_url("community/achievement_staff/getstaff"); ?>',
                data: {
                    unit: val
                },
                type: 'post',
