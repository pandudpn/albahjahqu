<div class="row">
    <div class="col-xl-12">
        <div class="page-title-box">
            <h4 class="page-title float-left">Penghargaan Sekolah / Pesantren / Kantor</h4>
...
<div class="row">
    <div class="col-12">
        <div class="p-20">
            <a href="<?php echo site_url('community/achievement/add'); ?>"><button class="btn btn-sm btn-primary waves-effect waves-light">
        ...
        <div class="card-box table-responsive" style="overflow-x: auto; zoom: 0.8;">
            ...
            <form method="get" id="formSearch">
                <div class="row" style="margin-bottom: 15px; margin-left: 5px;">
                    ...
                    <div class="col-2"><button class="btn btn-primary">Cari</button> <a href="<?= site_url('community/achievement'); ?>" class="btn btn-secondary">Reset</a></div>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    function DataTable(filter){
        $('#datatable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('community/achievement/datatables')?>?type="+filter,
                "type": "POST"
            },
            "columnDefs": [
                { 
