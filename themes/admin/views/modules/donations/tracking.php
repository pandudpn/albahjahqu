...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="<?php echo site_url('donations/tracking_save/'.$donation); ?>" enctype="multipart/form-data">
                        <input type="hidden" value="<?php echo $data->id; ?>" name="id">

                        <div class="form-group row">
                            <label for="" class="col-3 col-form-label">Kabar Terbaru</label>
                            <div class="col-9">
                                <textarea class="form-control editor" id="editor1" name="message" rows="15"><?php echo $data->message; ?></textarea>
                            </div>
                        </div>
