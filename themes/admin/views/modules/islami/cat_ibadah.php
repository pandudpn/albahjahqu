<div class="row">
    <div class="col-xl-12">
        <div class="page-title-box">
            <h4 class="page-title float-left">Kategori Panduan Ibadah</h4>
...
<div class="row">
    <div class="col-12">
        <div class="p-20">
            <a href="<?php echo site_url('islami/category_ibadah/add'); ?>"><button class="btn btn-sm btn-primary waves-effect waves-light">
                <i class="zmdi zmdi-collection-plus"></i> Tambah Kategori </button>
            </a>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('islami/category_ibadah/datatables')?>",
                "type": "POST"
            },
