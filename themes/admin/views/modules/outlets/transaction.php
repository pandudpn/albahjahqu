...
<div class="row">
    <div class="col-12">
    	<a href="<?php echo site_url('outlets'); ?>" class="btn btn-sm btn-primary" style="margin-bottom: 10px;">&laquo; Back</a>
        ...
        <div class="card-box table-responsive" style="overflow-x: auto; zoom: 0.8;">
            ...
            <form method="get">
                <div class="row" style="margin-bottom: 15px; margin-left: 5px;">
                    ...
                    <div class="col-3"><button class="btn btn-primary">Go</button> <a href="<?php echo site_url('outlets/transaction/'.$outlet_number); ?>" class="btn btn-secondary">Reset</a></div>
                </div>
            </form>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('outlets/transaction/datatables?from='.$from.'&to='.$to.'&outlet_number='.$outlet_number)?>",
                "type": "POST"
            },
