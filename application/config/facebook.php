...
*/
$config['facebook_app_id']              = '1312423878844374';
$config['facebook_app_secret']          = '775ebba6d96223d7688fc6d2e02641c6';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'facebook_connect';
$config['facebook_logout_redirect_url'] = 'logout';
$config['facebook_permissions']         = array('email', 'public_profile', 'user_friends');
