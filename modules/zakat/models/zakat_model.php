...
class zakat_model extends MY_Model {
    ...
    protected $column_order  = array(null, 'name', 'created_on'); //set column field database for datatable orderable
    protected $column_search = array('name', 'created_on'); //set column field database for datatable searchable 
