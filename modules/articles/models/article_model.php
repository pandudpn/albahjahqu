...
class article_model extends MY_Model {
    ...
    protected $column_order  = array(null, 'for', 'title', 'created_on'); //set column field database for datatable orderable
    protected $column_search = array('for', 'title', 'headlines', 'created_on'); //set column field database for datatable searchable 
