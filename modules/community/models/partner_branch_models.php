...
class partner_branch_models extends MY_Model {
    ...
    protected $column_order  = array(null, 'obb_partners.partner_branch.name', 'type'); //set column field database for datatable orderable
    protected $column_search = array('obb_partners.partner_branch.name', 'type', 'address', 'obb_partners.geo_provinces.name', 'obb_partners.geo_cities.name', 'obb_partners.geo_districts.name'); //set column field database for datatable searchable 
    protected $order         = array('type' => 'ASC', 'obb_partners.partner_branch.name' => 'ASC', 'obb_partners.partner_branch.level' => 'ASC'); // default order 
    ...
    public function get_type($where=array()){
        $this->db->select('DISTINCT(level) AS level', FALSE);
