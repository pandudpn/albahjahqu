...
class customer_model extends MY_Model {
    ...
    protected $column_order  = array(null, 'name', 'phone', 'email', 'outlet_number', 'dealer_name', 'account_status', 'kyc_status', 'referral_code', 'modified_on', 'created_on'); //set column field database for datatable orderable
    protected $column_search = array('name', 'phone', 'email', 'outlet_number', 'dealer_name', 'account_status', 'kyc_status', 'referral_code'); //set column field database for datatable searchable 
