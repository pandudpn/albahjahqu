...
class topics_model extends MY_Model {
    ...
    protected $column_order  = array(null, 'name', 'status'); //set column field database for datatable orderable
    protected $column_search = array('name', 'status'); //set column field database for datatable searchable 
