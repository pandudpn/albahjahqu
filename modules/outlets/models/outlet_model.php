...
class outlet_model extends MY_Model {
    ...
    protected $column_order  = array(null, 'name', 'outlet_number', 'outlet_name', 'level', 'dealer_name'); //set column field database for datatable orderable
    protected $column_search = array('name', 'outlet_number', 'outlet_name', 'level', 'dealer_name'); //set column field database for datatable searchable 
