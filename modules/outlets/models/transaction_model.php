...
class transaction_model extends MY_Model {
    ...
    protected $column_order  = array(null, 'transactions.created_on', 'trx_code', 'ref_service_codes.remarks', 'dealer_box_stock_usages.slot','biller_name', 'ref_code', 'cus_phone', 'destination_no', 'selling_price', 'base_price', 'dealer_fee', 'biller_fee', 'dekape_fee', 'partner_fee', 'user_fee', 'user_cashback', 'transactions.status'); //set column field database for datatable orderable
    ...
    {
    	$outlet_number     = $this->input->get('outlet_number');

    	if(empty($outlet_number))
    	{
    		return array();
    	}
        ...
        $this->db->where($this->table_customer.'.outlet_number', $outlet_number);
