...
class eva_customer_migration_model extends MY_Model {

	protected $table        = 'customer_migrations';
    protected $key          = 'id';
    protected $date_format  = 'datetime';
    protected $set_created  = true;

    protected $column_order  = array(null, 'name', 'eva', 'old_balance', 'migration_balance', 'modified_on', 'created_on'); //set column field database for datatable orderable
    protected $column_search = array('name', 'eva', 'old_balance', 'migration_balance', 'modified_on', 'created_on'); //set column field database for datatable searchable 
    protected $order 		 = array('modified_on' => 'asc'); // default order 
    ...
    public function _get_datatables_query()
    {
        ...
        $this->db->where($this->table.'.equal', '0');
